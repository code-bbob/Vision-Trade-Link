...
export default function VendorTransactions() {
  ...
  const handleSearch = async (e) => {
    ...
    setLoading(true)
    try {
      const response = await api.get(`transaction/vendortransaction/?search=${localSearchTerm}`)
      setTransactions(response.data.results)
      setMetadata({
        next: response.data.next,
        previous: response.data.previous,
  ...
  const handleDateSearch = async (e) => {
    ...
    setLoading(true)
    try {
      const response = await api.get(`transaction/vendortransaction/?start_date=${startDate}&end_date=${endDate}`)
      setTransactions(response.data.results)
      setMetadata({
        next: response.data.next,
        previous: response.data.previous,
