...
export default function EMIDebtorTransactionForm() {
  const api = useAxios();
  ...
  useEffect(() => {
    api
      .get(`transaction/emidebtors/branch/${branchId}/`)
  ...
  useEffect(() =>{
    api
      .get(`inventory/brand/branch/${branchId}/`)
      .then(res => {
        setBrands(res.data);
  ...
  const handleSubmit = async e => {
    ...
    setSubmitting(true);
    try {
      await api.post("transaction/emidebtortransaction/", formData);
